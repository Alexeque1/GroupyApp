...
import { Camera, ImagePlus, RotateCcw, X, ZoomIn, ZoomOut } from "lucide-react";
...
interface ProfileModalChangeProfilePhotoProps {
    isOpen: boolean;
    onClose: () => void;
...
export default function ProfileModalChangeProfilePhoto({
    isOpen,
    onClose,
    onSave,
    currentImage = null,
}: ProfileModalChangeProfilePhotoProps) {
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-black/50 dark:text-white/50">
                                        {rawImage
                                            ...
                                            : "Upload a new picture to represent you."}
                                    </p>
                                </div>
                            </div>
                            <button
                        ...
                        <div className="flex flex-1 flex-col gap-4 overflow-y-auto p-6">
                            {rawImage ? (
                                ...
                                <div
                                    ...
                                    onDrop={handleDrop}
                                    className={cn(
                                        "group relative mx-auto flex h-56 w-56 cursor-pointer flex-col items-center justify-center gap-2 overflow-hidden rounded-full border-2 border-dashed transition-all",
                                        isDragging
                                ...
                                >
                                    ...
                                    />
                                    <p className="relative z-10 px-6 text-center text-xs text-black/50 dark:text-white/50">
                                        <span className="font-semibold text-brand-purple">Click to upload</span>
                                        <br />
                                        or drag and drop
                                    </p>
                                </div>
