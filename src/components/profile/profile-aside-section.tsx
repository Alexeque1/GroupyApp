...
export default function ProfileAside() {
    return (
        <aside className="flex flex-col flex-1 gap-6 rounded-3xl border border-black/30 bg-white/5 p-6 shadow-[0_8px_30px_rgba(0,0,0,0.08)] backdrop-blur-sm h-fit">
            ...
            <div className="flex flex-col gap-4">
                ...
                <ul className="flex flex-col gap-3">
                    {/* Evento 1 */}
                    <li className="flex items-center gap-3 rounded-2xl border border-black/5 bg-black/5 p-3 transition-colors hover:bg-black/10 cursor-pointer">
                        {/* Fecha */}
                        ...
                        <div className="flex flex-col flex-1 overflow-hidden">
                            <h4 className="truncate text-sm font-semibold text-black/80">Tech Meetup 2026</h4>
                            <p className="flex items-center gap-1 text-xs text-black/50 mt-0.5">
                                <Calendar size={12} />
                                18:00 hs
                            </p>
                        </div>
                    ...
                    <li className="flex items-center gap-3 rounded-2xl border border-black/5 bg-black/5 p-3 transition-colors hover:bg-black/10 cursor-pointer">
                        ...
                        <div className="flex flex-col flex-1 overflow-hidden">
                            <h4 className="truncate text-sm font-semibold text-black/80">Festival de Jazz</h4>
                            <p className="flex items-center gap-1 text-xs text-black/50 mt-0.5">
                                <Calendar size={12} />
                                20:30 hs
                            </p>
