...
export default function FriendCard({ friend }: { friend: FriendType }) {
    ...
    return (
        <div
            className={`group relative flex cursor-pointer items-center justify-between rounded-2xl border border-black/10 bg-white p-4 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_8px_30px_rgba(0,0,0,0.06)] ${isMenuOpen ? "z-50" : "z-10 hover:z-20"
                }`}
        >
            {/* AVATAR E INFO */}
